    ...
    $("#jqGrid").jqGrid({
        ...
        colModel: [
                                                {label: '${column.columnComment}',name: 'id',index: 'id',width: 0,key: true,hidden: true},
                                                                {label: '${column.columnComment}',name: 'userid',index: 'userid',width: 80}, 
                                                                {label: '${column.columnComment}',name: 'mcurrid',index: 'mcurrid',width: 80}, 
                                                                {label: '${column.columnComment}',name: 'createtime',index: 'createtime',width: 80}
