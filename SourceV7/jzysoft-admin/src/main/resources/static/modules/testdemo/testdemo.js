$(function () {
    $("#jqGrid").jqGrid({
        url: baseURL + 'testdemo/testdemo/list',
        datatype: "json",
        colModel: [
...
var vm = new Vue({
    ...
    methods: {
        ...
        editPage: function (x) {
            ...
            $.ajax({
                url: baseURL + 'testdemo/testdemo/findByid',
                type: "GET",
                data: {
                    id: id,
                },
        ...
        saveOrUpdate: function (id) {
            var url = id == null ? "testdemo/testdemo/adddata" : "testdemo/testdemo/updatedata";
            $.ajax({
                url: baseURL + url,
                type: "POST",
        ...
        del: function (event) {
            ...
            var r = layer.confirm('您确定要删除该用户吗?', {btn: ['确定', '取消'], title: "提示"}, function () {
                if (r) {
                    $.ajax({
                        type: "POST",
                        url: baseURL + "/testdemo/testdemo/del",
                        contentType: "application/json",
