...
import com.jzysoft.framework.shiro.service.SysPasswordService;
...
@Api(value = "/system/user", description = "用户中心")
public class SysUserController extends BaseController {
    ...
    public RJQ getAllStudent(@RequestBody PageData pageData) {
        ...
        for (SysRole sysRole : sysRoles) {
            if (sysRole.getRoleName().equals(pageData.getString("rolename"))) {
                stuRoll = sysRole;
            }
        }
